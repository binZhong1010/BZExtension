...
/** Category of additions for `<ALDataBase>` class.
...
@interface ALDataBase (ALDataBaseAdditions)
...
/** The schema of the database.
 ...
 @return `ALResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (ALResultSet*)getSchema;
...
- (ALResultSet*)getTableSchema:(NSString*)tableName;
