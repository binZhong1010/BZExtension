...
#define is67InchDevice ([UIDevice currentDevice].screenType==UIDEVICE_6_7_INCH)
#define isXSeriesDevice ([UIDevice currentDevice].screenType==UIDEVICE_5_8_INCH || [UIDevice currentDevice].screenType==UIDEVICE_6_5_INCH || [UIDevice currentDevice].screenType==UIDEVICE_6_7_INCH)
...
#define isRunningOnIOS13          [[UIDevice currentDevice] isIOS13]
#define iOSNavHeight              (isXSeriesDevice?(is67InchDevice?91:88):64)
#define iOSStatusBarHeight        (isXSeriesDevice?(is67InchDevice?47:44):20)
#define iphoneXBottomAreaHeight   (isXSeriesDevice?34:0)
#define iOSTopHeight              (isXSeriesDevice?(is67InchDevice?27:24):0)
