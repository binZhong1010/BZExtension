...
@implementation NSData (ALNKBase64)
...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = al_NewBase64Decode([data bytes], [data length], &outputLength);
...
//	receiver.
//
- (NSString *)al_base64EncodedString
{
