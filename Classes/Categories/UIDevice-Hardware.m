...
- (NSUInteger) platformType
{
  ...
  if ([platform hasPrefix:@"iPhone9,2"]||
      [platform hasPrefix:@"iPhone9,4"])          return UIDevice7PlusiPhone;
  if ([platform hasPrefix:@"iPhone10,1"]||
      [platform hasPrefix:@"iPhone10,4"])         return UIDevice8iPhone;
  if ([platform hasPrefix:@"iPhone10,2"]||
      [platform hasPrefix:@"iPhone10,5"])         return UIDevice8PlusiPhone;
  if ([platform hasPrefix:@"iPhone10,3"]||
      [platform hasPrefix:@"iPhone10,6"])         return UIDeviceXiPhone;
  if ([platform hasPrefix:@"iPhone11,2"])         return UIDeviceXsiPhone;
  if ([platform hasPrefix:@"iPhone11,4"]||
      [platform hasPrefix:@"iPhone11,6"])         return UIDeviceXsMaxiPhone;
  if ([platform hasPrefix:@"iPhone11,8"])         return UIDeviceXRiPhone;
  if ([platform hasPrefix:@"iPhone12,1"])         return UIDevice11iPhone;
  if ([platform hasPrefix:@"iPhone12,3"])         return UIDevice11ProiPhone;
  if ([platform hasPrefix:@"iPhone12,5"])         return UIDevice11ProMaxiPhone;
  if ([platform hasPrefix:@"iPhone11,8"])         return UIDeviceSE2iPhone;
  if ([platform hasPrefix:@"iPhone13,1"])         return UIDevice12MiniiPhone;
  if ([platform hasPrefix:@"iPhone13,2"])         return UIDevice12iPhone;
  if ([platform hasPrefix:@"iPhone13,3"])         return UIDevice12ProiPhone;
  if ([platform hasPrefix:@"iPhone13,4"])         return UIDevice12ProMaxiPhone;
  // iPod
...
- (BOOL)isIOS12{
  ...
  if (result == -1) {
    NSNumber *majorVersion = [[self.systemVersion componentsSeparatedByString:@"."] safeObjectAtIndex:0];
    result = majorVersion.integerValue >= 12;
  }
  return (BOOL)result;
}
...
- (BOOL)isIOS13{
  ...
  if (result == -1) {
    NSNumber *majorVersion = [[self.systemVersion componentsSeparatedByString:@"."] safeObjectAtIndex:0];
    result = majorVersion.integerValue >= 13;
  }
  return (BOOL)result;
}
...
- (BOOL)isIOS14{
  ...
  if (result == -1) {
    NSNumber *majorVersion = [[self.systemVersion componentsSeparatedByString:@"."] safeObjectAtIndex:0];
    result = majorVersion.integerValue >= 14;
  }
  return (BOOL)result;
}
...
- (UIDeviceSreenType) screenType{
  ...
  }else if ([UIScreen mainScreen].bounds.size.height > 480 && [UIScreen mainScreen].bounds.size.height<=568){
  ...
  else if ([UIScreen mainScreen].bounds.size.height > 812 && [UIScreen mainScreen].bounds.size.height<=896){
    return UIDEVICE_6_5_INCH;
  }
  else if ([UIScreen mainScreen].bounds.size.height > 896 && [UIScreen mainScreen].bounds.size.height<=926){
    return UIDEVICE_6_7_INCH;
  }
