...
- (instancetype)init
{
  if ((self = [super init]))
  {
    _soundVolume = 1.0f;
    _musicVolume = 1.0f;
    _soundFadeDuration = 0.5;
    _musicFadeDuration = 0.5;
...
- (float)currentMusicVolume{
  [_currentMusic.sound updateMeters];
  return pow(10, (0.05 * [_currentMusic.sound peakPowerForChannel:0]));
}
